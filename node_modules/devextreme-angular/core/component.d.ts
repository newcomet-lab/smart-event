 ...
 */
import { ElementRef, NgZone, QueryList, AfterViewInit } from '@angular/core';
...
export declare abstract class DxComponent implements AfterViewInit, INestedOptionContainer, ICollectionNestedOptionContainer, IDxTemplateHost {
    ...
    protected _updateOption(name: string, value: any): void;
