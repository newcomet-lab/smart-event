 ...
 */
export declare class DxFilterBuilderComponent extends DxComponent implements OnDestroy, AfterContentInit, ControlValueAccessor, OnChanges, DoCheck {
     ...
     * A handler for the ${optionName}Change event.
     */
    filterOperationDescriptionsChange: EventEmitter<any>;
    /**
     * A handler for the ${optionName}Change event.
     */
     ...
     * A handler for the ${optionName}Change event.
     */
    groupOperationDescriptionsChange: EventEmitter<any>;
    /**
     * A handler for the ${optionName}Change event.
     */
