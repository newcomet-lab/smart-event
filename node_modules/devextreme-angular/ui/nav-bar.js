 ...
 */
var DxNavBarComponent = (function (_super) {
    __extends(DxNavBarComponent, _super);
    function DxNavBarComponent(elementRef, ngZone, templateHost, _watcherHelper, _idh, optionHost) {
    ...
    DxNavBarComponent.prototype._createInstance = function (element, options) {
        return new nav_bar_1.default(element, options);
    };
    ...
    DxNavBarComponent.prototype._updateOption = function (name, value) {
    ...
    DxNavBarComponent.propDecorators = {
...
var DxNavBarModule = (function () {
    function DxNavBarModule() {
    }
    DxNavBarModule.decorators = [
    ...
    /** @nocollapse */
    DxNavBarModule.ctorParameters = function () { return []; };
