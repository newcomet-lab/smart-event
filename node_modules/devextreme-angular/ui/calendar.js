...
var DxCalendarComponent = (function (_super) {
    ...
    function DxCalendarComponent(elementRef, ngZone, templateHost, _watcherHelper, _idh, optionHost) {
    ...
    DxCalendarComponent.prototype.ngOnChanges = function (changes) {
        this._idh.setup('disabledDates', changes);
    };
    DxCalendarComponent.prototype.ngDoCheck = function () {
        this._idh.doCheck('disabledDates');
        this._watcherHelper.checkWatchers();
    };
    DxCalendarComponent.prototype._updateOption = function (name, value) {
    ...
    DxCalendarComponent.prototype.ngAfterContentInit = function () {
        if (this.validator) {
